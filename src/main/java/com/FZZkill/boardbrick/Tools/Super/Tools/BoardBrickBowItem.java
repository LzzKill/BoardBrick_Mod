...
public class BoardBrickBowItem extends ShootableItem implements IVanishable {

    public BoardBrickBowItem(Item.Properties p_i48522_1_) {
        super(p_i48522_1_);
    }
    ...
    public ActionResult<ItemStack> use(World p_77659_1_, PlayerEntity p_77659_2_, Hand p_77659_3_) {
        ...
        p_77659_2_.addItem(Items.ARROW.getDefaultInstance());
