...
public class BoardBrickHoeItem extends BoardBrickToolItem {
    ...
    public BoardBrickHoeItem(IItemTier p_i231595_1_, int p_i231595_2_, float p_i231595_3_, Item.Properties p_i231595_4_) {
